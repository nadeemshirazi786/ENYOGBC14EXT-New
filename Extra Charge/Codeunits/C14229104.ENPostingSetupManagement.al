codeunit 14229104 ENPostingSetupManagement
{
    ...
    procedure SendECPostingSetupNotification(ECPostingSetup: Record "EN Extra Charge Posting Setup"; FieldCaption: Text)
    begin
        // P80053245
        if not IsPostingSetupNotificationEnabled then
            exit;
    ...
    var
        ECPostingSetupRec: Record "EN Extra Charge Posting Setup";
        ECPostingSetupPage: Page "EN Extra Charge Posting Setup";
        BusPostingGroupCode: Code[20];
        ProdPostingGroupCode: Code[20];
