table 14229419 "Post. Item Chg Asgn Purch ELA"
{
    // ENRE1.00 2021-09-08 AJ
    // 
    // ENRE1.00
    //    - new table based on 5805
    //    - added field Distribution Type (option --> Equal,Amount,Weight,Custom)
    //    - add Orig. Document fields
    //    - add new key --> (Orig. Doc. Type,Orig. Doc. No.,Item Charge No.)
    //    - add key --> (Applies-to Doc. Type,Applies-to Doc. No.,Item Charge No.)
