table 14228860 "EN Order Rule Detail Line"
{
    ...
    fields
    {
        ...
        {
            TableRelation = IF ("Sales Type"=CONST("Customer")) Customer ELSE IF ("Sales Type"=CONST("Order Rule Group")) "EN Order Rule Group";
        }
        ...
        {
            TableRelation = IF ("Item Type"=CONST("Item No.")) "Item Unit of Measure".Code WHERE ("Item No."=FIELD("Item Ref. No.")) ELSE "Unit of Measure".Code;
        }
