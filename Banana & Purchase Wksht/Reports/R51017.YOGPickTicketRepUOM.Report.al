report 51017 "YOG Pick Ticket Rep UOM"
{
    ...
    // 
    // DP20180613  - New version that uses YOG Reporting UOM for On Hand
    // DP20190124  - Shelf No. comes from Item as opposed to SKU; also set Sort by Item Shelf No.
    // 
    // CCLL - Expanded Address from 30 to 50
    // IB20227BS 20192003 - Show value for Total Picked
    DefaultLayout = RDLC;
    ApplicationArea = All;
    UsageCategory = ReportsAndAnalysis;
    RDLCLayout = './YOGPickTicketRepUOM.rdl';
            ...
            dataitem(Location; Location)
            {
                ...
                dataitem(CopyLoop; "Integer")
                {
                    dataitem(Lines; "Integer")
                    {
                        ...
                        column(TotalPicked; gTotalPicked)
                        {
                        }
                        ...
                        begin
                            ...
                            IF gSalesLineTMP."No." <> '' THEN BEGIN
                                ...
                                ItemLedger.CALCSUMS(ItemLedger."Reporting Qty. ELA");     //DP20180613
                                gOnHandQty := ItemLedger."Reporting Qty. ELA";            //DP20180613
                                ...
                                IF lWhseActivityLine.FINDFIRST THEN BEGIN
                                    REPEAT
                                        ...
                                        gTotalPicked := gTotalPicked + gQtyPicked; //</IB20227BS>
    ...
    var
        ...
        Address: array[7] of Text[50];
        ShipToAddress: array[7] of Text[50];
        NoCopies: Integer;
        TotalCases: Decimal;
        TotalLbs: Decimal;
