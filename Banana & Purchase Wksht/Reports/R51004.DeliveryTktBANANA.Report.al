report 51004 "Delivery Tkt BANANA"
{
    DefaultLayout = RDLC;
    RDLCLayout = './DeliveryTktBANANA.rdlc';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(SalesLine; "Integer")
                    {
                        ...
                        begin
                            ...
                            grecSalesLine.SETRANGE("Attached to Line No.", TempSalesLine."Line No.");
            ...
            begin
                ...
                SalesNoBarcode := '*' + COPYSTR(FORMAT("No."), 3, 7) + '*';
