report 50086 "Delivery Tkt UPC Barcode Live"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './DeliveryTktUPCBarcodeLive.rdl';
    ApplicationArea = All;
    UsageCategory = ReportsAndAnalysis;
    Caption = 'Delivery Tkt UPC Barcode LIVE';
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem("Sales Line"; "Sales Line")
            {
                ...
                begin
                    ...
                    //<IB58450RTH>
                    TempSalesLine."EDI Line No. ELA" := TempSalesLine."Line No.";  // Need this later when looking for charge item lines
                    //<IB58450RTH>
                    ...
                    dataitem(SalesLine; "Integer")
                    {
                        ...
                        begin
                            ...
                            WITH TempSalesLine DO BEGIN
                                ...
                                grecSalesLine.SETRANGE("Attached to Line No.", "EDI Line No. ELA"); // Looks odd, but this is the 'real' line number
    ...
    var
        ...
        grecUOMSize: Record "Unit Of Measure Size ELA";
        QtyShort: Decimal;
        QtyShipped: Decimal;
        BotDep: Decimal;
