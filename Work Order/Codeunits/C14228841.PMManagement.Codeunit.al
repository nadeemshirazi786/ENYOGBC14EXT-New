codeunit 23019250 "PM Management"
{
    ...
    [Scope('Internal')]
    procedure CreateNewVersion(precPMProcedure: Record "23019250")
    var
        lrecPMProcedure: Record "23019250";
        lrecPMProcedure2: Record "23019250";
        lrecPMProcLines: Record "23019251";
        lrecPMProcLines2: Record "23019251";
        lrecPMPItemCons: Record "23019252";
        lrecPMPItemCons2: Record "23019252";
        lrecPMPResmentReq: Record "23019253";
        lrecPMPResmentReq2: Record "23019253";
        lrecPMProcComments: Record "23019258";
        lrecPMProcComments2: Record "23019258";
    begin
    ...
    [Scope('Internal')]
    procedure CreatePMWOFromVersion(var pcodPMWONo: Code[20]; precPMProcedure: Record "23019250")
    var
        lrecPMWOHeader: Record "23019260";
        lrecPMProcedure: Record "23019250";
        lrecPMProcedure2: Record "23019250";
        lrecPMProcLines: Record "23019251";
        lrecPMWOLine: Record "23019261";
        lrecPMPItemCons: Record "23019252";
        lrecPMWOItemCons: Record "23019262";
        lrecPMPResmentReq: Record "23019253";
        lrecPMWOResource: Record "23019263";
        lrecPMProcComments: Record "23019258";
        lrecPMWOComments: Record "23019264";
    ...
    [Scope('Internal')]
    procedure SuggestPMWOFaults(var precPMWOLine: Record "23019261")
    var
        lrecPMProcedure: Record "23019250";
        lrecPMPFaults: Record "23019266";
        lrecPMWOFaults: Record "23019265";
    begin
    ...
    var
        lrecPMWkshtBatch: Record "23019268";
    begin
        lrecPMWkshtBatch.GET(pcodCurrWkshtBatchName);
    end;

    [Scope('Internal')]
    procedure SetName(pcodCurrWkshtBatchName: Code[10]; var precPMWksht: Record "23019267")
    begin
    ...
    [Scope('Internal')]
    procedure LookupName(var pcodCurrWkshtBatchName: Code[10]; var precPMWksht: Record "23019267"): Boolean
    var
        lrecPMWkshtBatch: Record "23019268";
    begin
        COMMIT;
