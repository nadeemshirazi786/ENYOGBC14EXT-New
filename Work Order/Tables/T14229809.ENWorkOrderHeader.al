table 14229809 "Work Order Header ELA"
{
    DrillDownPageID = "PM Work Order List";
    LookupPageID = "PM Work Order List";
    ...
    fields
    {
        ...
        {
            CalcFormula = Exist ("Work Order Line ELA" WHERE ("PM Work Order No." = FIELD ("PM Work Order No."),
        ...
        {
            CalcFormula = Sum ("Work Order Line ELA"."PM Measure Cost" WHERE ("PM Work Order No." = FIELD ("PM Work Order No.")));
            Editable = false;
            FieldClass = FlowField;
        }
    ...
    var
        ...
        lrecPMPResReq: Record "PM Resource ELA";
        lrecPMProcComments: Record "PM Proc. Comment ELA";
        lfrmPMProcedureList: Page "PM Procedure List";
        lcduPMMgt: Codeunit "PM Management ELA";
    begin
    ...
    [Scope('Internal')]
    procedure AssistEdit(precOldPMWOHeader: Record "Work Order Header ELA"): Boolean
    var
        lrecPMWOHeader: Record "Work Order Header ELA";
    begin
