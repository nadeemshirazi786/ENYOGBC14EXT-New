table 14229801 "PM Procedure Line ELA"
{
    fields
    {
        ...
        {
            CalcFormula = Exist ("PM Item Consumption ELA" WHERE ("PM Procedure Code" = FIELD ("PM Procedure Code"),
        ...
        {
            CalcFormula = Exist ("PM Resource ELA" WHERE ("PM Procedure Code" = FIELD ("PM Procedure Code"),
                                                     "Version No." = FIELD ("Version No."),
                                                     "PM Procedure Line No." = FIELD ("Line No.")));
            Editable = false;
            FieldClass = FlowField;
        ...
        {
            CalcFormula = Exist ("PM Proc. Comment ELA" WHERE ("PM Procedure Code" = FIELD ("PM Procedure Code"),
                                                          "Version No." = FIELD ("Version No."),
                                                          "PM Procedure Line No." = FIELD ("Line No.")));
            Editable = false;
            FieldClass = FlowField;
    ...
    var
        ...
        lrecPMPResment: Record "PM Resource ELA";
    ...
    var
        ...
        //lcduApplMgt: Codeunit "Application Area Mgmt.";
    begin
        case "Value Type" of
            "Value Type"::Boolean:
                begin
