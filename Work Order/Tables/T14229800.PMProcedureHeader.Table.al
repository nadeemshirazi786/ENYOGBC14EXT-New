table 14229800 "PM Procedure Header ELA"
{
    ...
    fields
    {
        ...
        {
            CalcFormula = Max ("Finished WO Header ELA"."Work Order Date" WHERE ("PM Procedure Code" = FIELD (Code)));
            Editable = false;
        ...
        {
            CalcFormula = Exist ("PM Procedure Line ELA" WHERE ("PM Procedure Code" = FIELD (Code),
        ...
        {
            CalcFormula = Exist ("PM Proc. Comment ELA" WHERE ("PM Procedure Code" = FIELD (Code),
                                                          "Version No." = FIELD ("Version No."),
        ...
        {
            CalcFormula = Max ("Finished WO Header ELA"."Evaluated At Qty." WHERE ("PM Procedure Code" = FIELD (Code),
                                                            Type = FIELD (Type),
                                                            "No." = FIELD ("No.")));
            Editable = false;
            FieldClass = FlowField;
    ...
    var
        ...
        lrecPMCalcMethods: Record "PM Calc. Methods ELA";
    begin
    ...
    [Scope('Internal')]
    procedure AssistEdit(precOldPMProcedure: Record "PM Procedure Header ELA"): Boolean
    var
