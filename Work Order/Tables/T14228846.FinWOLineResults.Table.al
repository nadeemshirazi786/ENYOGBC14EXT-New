table 14228846 "Fin. WO Line Results"
{
    DrillDownPageID = 23019276;
    LookupPageID = 23019276;
    ...
    [Scope('Internal')]
    procedure jfdoPMWOResultsLookup(precFinPMWOLine: Record "Finished WO Line"; pblnLookupForm: Boolean): Decimal
    var
        lfrmFinPMWOLineResults: Page Page23019276;
        lrecFinPMWOLineResults: Record "Fin. WO Line Results";
