table 23019267 "PM Planning Worksheet"
{
    ...
    fields
    {
        field(1; "Worksheet Batch Name"; Code[10])
        {
            ...
            TableRelation = "PM Worksheet Batch";
        }
        ...
        field(4; "Version No."; Code[10])
        {
            ...
            TableRelation = "PM Procedure Header"."Version No." WHERE (Code = FIELD (Description));
    ...
    var
        grecPMWkshtBatch: Record "PM Worksheet Batch";
        grecPMWkshtLine: Record "PM Planning Worksheet";
    ...
    var
        lrecLastPMWkshtLine: Record "PM Planning Worksheet";
    begin
