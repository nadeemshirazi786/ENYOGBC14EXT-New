report 14228833 "Calc. Phys. Invt. Count. ELA"
{
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    field("Calculate Inventory by"; goptCalcInvBy)
                    {
                        ApplicationArea = Warehouse;
    ...
    var
        ...
        goptCalcInvBy: Option "Location","Loc./Bin/Lot/Serial No.","Loc./Lot/Serial No.";
        gblnCalcInvBy: Boolean;
    ...
    procedure jfGetRequestRprtOption(VAR poptCalcInvBy: Option "Location","Loc./Bin/Lot/Serial No.","Loc./Lot/Serial No.")
    begin
        poptCalcInvBy := goptCalcInvBy;
    end;
}
