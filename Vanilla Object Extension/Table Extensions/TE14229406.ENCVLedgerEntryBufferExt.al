tableextension 14229406 "CV Ledger Entry Buffer ELA" extends "CV Ledger Entry Buffer"
{
        ...
        field(14228813; "Rebate Vendor No. ELA"; Code[20])
        {
            ...
            begin
                ...
                if "Rebate Vendor No. ELA" <> '' then begin
                    lrecVend.Get("Rebate Vendor No. ELA");
                    "Vendor Rebate Group ELA" := lrecVend."Rebate Group Code ELA";
                end else begin
