tableextension 14228870 "EN Sales Cr. Memo Line Ext" extends "Sales Cr.Memo Line"
{
    fields
    {
    ...
    begin
        ...
        pdecDeliveredPrice :=
          RebateFunctions.CalcDeliveredPrice(DATABASE::"Sales Cr.Memo Line", 0, "Document No.", "Line No.", "Unit Price");
