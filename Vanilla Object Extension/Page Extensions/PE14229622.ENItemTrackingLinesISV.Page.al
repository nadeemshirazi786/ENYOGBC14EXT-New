page 14229622 "EN LT ItemTrackLineISV EXT ELA"
{
    Caption = 'Item Tracking Lines ISV';
    ...
    layout
    {
        area(content)
        {
            ...
            repeater(Control1)
            {
                ...
                field("Supplier Lot No."; "Supplier Lot No. ELA")
                {
                    Visible = ShowAdditionalLotData;
                }
                field("Lot Creation Date"; "Lot Creation Date ELA")
                {
                    Caption = 'Creation Date';
                    Visible = ShowAdditionalLotData;
                }
                field("Country/Region of Origin Code"; "Country/Regn of Orign Code ELA")
                {
                    Visible = ShowAdditionalLotData;
                }
                ...
                field("Quantity (Alt.) ELA"; "Quantity (Alt.) ELA")
                {
                    ApplicationArea = All;
                }
                field("Qty. to Handle (Alt.) ELA"; "Qty. to Handle (Alt.) ELA")
                {
                    ApplicationArea = All;
                }
                field("Quantity Handled (Alt.) ELA"; "Quantity Handled (Alt.) ELA")
                {
                    ApplicationArea = All;

                }
                field("Qty. to Invoice (Alt.) ELA"; "Qty. to Invoice (Alt.) ELA")
                {
                    ApplicationArea = All;

                }
                field("Quantity Invoiced (Alt.) ELA"; "Quantity Invoiced (Alt.) ELA")
                {
                    ApplicationArea = All;
                }
            }
    ...
    begin
        ...
        // P8001106
        ShowAdditionalLotData := // P8008351
          (TrackingSpecification."Source Type" = DATABASE::"Purchase Line") and
          (TrackingSpecification."Source Subtype" = 1); // Order
        // P8001106
    ...
    var
        ...
        CreateReservEntry: Codeunit "Create Reserv. Entry ISV ELA";
            ...
            ChangeType::Insert:
                begin
                    ...
                    if FormRunMode = FormRunMode::Reclass then begin
                        ...
                        CreateReservEntry.SetNewLotStatus(OldTrackingSpecification."New Lot Status Code ELA"); // P8001083
                    end;
                    CreateReservEntry.SetDates(
                      NewTrackingSpecification."Warranty Date", NewTrackingSpecification."Expiration Date");
                    CreateReservEntry.SetSupplierLotNo(NewTrackingSpecification."Supplier Lot No. ELA"); // P8001106
                    CreateReservEntry.SetLotCreationDate(NewTrackingSpecification."Lot Creation Date ELA");             // P8008351
                    CreateReservEntry.SetCountryOfOrigin(NewTrackingSpecification."Country/Regn of Orign Code ELA"); // P8008351
    ...
    begin
        ...
        if NewTrackingSpec.Find('-') then
            repeat
                ...
                if not Find('-') then begin
                    ...
                    "Supplier Lot No. ELA" := NewTrackingSpec."Supplier Lot No. ELA"; // P8001106
                    "Expiration Date" := NewTrackingSpec."Expiration Date";                            // P8009351
                    "Lot Creation Date ELA" := NewTrackingSpec."Lot Creation Date ELA";                        // P8008351
                    "Country/Regn of Orign Code ELA" := NewTrackingSpec."Country/Regn of Orign Code ELA"; // P8008351
                    "New Serial No." := NewTrackingSpec."New Serial No."; // P8000343A
                    "New Lot No." := NewTrackingSpec."New Lot No.";       // P8000343A
                    "Phys. Inventory ELA" := NewTrackingSpec."Phys. Inventory ELA"; // P8001083
        ...
        if UpdateUndefinedQty then begin // P8000150A
            ...
            // P8000150A End
            if FormRunMode = FormRunMode::Transfer then // P8000267B
